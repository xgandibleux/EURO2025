...
\texttt{ \hspace{-2mm}\greenxg{julia>}   @show value(x1), value(x2)}
 ...
 \hspace{5mm}$\drsh$ {\tiny \url{https://github.com/xgandibleux/EURO2025/blob/main/2.examples/1IP.ipynb}}
...
\vspace{1mm}
 \hspace{5mm}$\drsh$ {\tiny \url{https://github.com/xgandibleux/EURO2025/blob/main/2.examples\/2IPim.ipynb}}
